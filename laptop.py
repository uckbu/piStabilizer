...
def process_frame(frame):
    ...
    # Adjust these values if needed based on your lighting conditions.
...
def main():
    cap = cv2.VideoCapture(0)  # Use the built-in webcam
    if not cap.isOpened():
        print("Error: Could not open webcam.")
        return

    time.sleep(2)
    print("Webcam stream opened successfully on ROG Flow X13.")
